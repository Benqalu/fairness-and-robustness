...
plot_params.title=['SVM (RBF)' ...
        ' - C=' num2str(classifier_params.svm_C) ...
        ', \gamma=' num2str(classifier_params.svm_gamma) ...
        ', \lambda=' num2str(mimicry_params.lambda)]; %Set up plot title
plot_params.legend_lk = 'LK'; %Set up legend for lk
plot_params.legend_pk = 'PK'; %Set up legend for pk
plot_params.color = 'b';
