...
plot_params.legend_lk = ['MLP - LK' ' (m=' num2str(classifier_params.neurons) ')']; %Set up legend for lk
plot_params.legend_pk = ['MLP - PK' ' (m=' num2str(classifier_params.neurons) ')']; %Set up legend for pk
plot_params.color = 'g';
